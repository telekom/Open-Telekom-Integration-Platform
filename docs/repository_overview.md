...
|-----------------------------------------------------------------------------------|:-----------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:--------------------------:|
| **[Gateway-Kong-Charts](https://github.com/telekom/gateway-kong-charts)**         |  **[latest](https://github.com/telekom/gateway-kong-charts/releases)**  |  **[8.1.7](https://github.com/telekom/gateway-kong-charts/releases/8.1.7)**   |  **[7.4.3](https://github.com/telekom/gateway-kong-charts/releases/7.4.3)**   |             ✅              |
| [Gateway-Kong-Image](https://github.com/telekom/gateway-kong-image)               |    [latest](https://github.com/telekom/gateway-kong-image/releases)     |     [1.2.1](https://github.com/telekom/gateway-kong-image/releases/1.2.1)     |     [1.0.1](https://github.com/telekom/gateway-kong-image/releases/1.0.1)     |             ✅              |
