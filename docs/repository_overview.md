...
|-----------------------------------------------------------------------------------|:-----------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:--------------------------:|
| **[Gateway-Kong-Charts](https://github.com/telekom/gateway-kong-charts)**         |  **[latest](https://github.com/telekom/gateway-kong-charts/releases)**  |  **[9.7.1](https://github.com/telekom/gateway-kong-charts/releases/9.7.1)**   |  **[9.6.1](https://github.com/telekom/gateway-kong-charts/releases/9.6.1)**   |             ✅              |
| [Gateway-Kong-Image](https://github.com/telekom/gateway-kong-image)               |    [latest](https://github.com/telekom/gateway-kong-image/releases)     |     [1.6.1](https://github.com/telekom/gateway-kong-image/releases/1.6.1)     |     [1.6.1](https://github.com/telekom/gateway-kong-image/releases/1.6.1)     |             ✅              |
...
| [Gateway-Jumper](https://github.com/telekom/gateway-jumper)                       |      [latest](https://github.com/telekom/gateway-jumper/releases)       |       [4.8.3](https://github.com/telekom/gateway-jumper/releases/4.8.3)       |       [4.8.1](https://github.com/telekom/gateway-jumper/releases/4.8.1)       |             ✅              |
