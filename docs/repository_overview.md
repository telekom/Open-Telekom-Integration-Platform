...
|-----------------------------------------------------------------------------------|:-----------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:--------------------------:|
| **[Gateway-Kong-Charts](https://github.com/telekom/gateway-kong-charts)**         |  **[latest](https://github.com/telekom/gateway-kong-charts/releases)**  |  **[8.1.2](https://github.com/telekom/gateway-kong-charts/releases/8.1.2)**   |  **[7.4.3](https://github.com/telekom/gateway-kong-charts/releases/7.4.3)**   |             ✅              |
| [Gateway-Kong-Image](https://github.com/telekom/gateway-kong-image)               |    [latest](https://github.com/telekom/gateway-kong-image/releases)     |     [1.1.0](https://github.com/telekom/gateway-kong-image/releases/1.1.0)     |     [1.0.1](https://github.com/telekom/gateway-kong-image/releases/1.0.1)     |             ✅              |
...
| [Gateway-Jumper](https://github.com/telekom/gateway-jumper)                       |      [latest](https://github.com/telekom/gateway-jumper/releases)       |       [4.2.4](https://github.com/telekom/gateway-jumper/releases/4.2.4)       |       [4.1.4](https://github.com/telekom/gateway-jumper/releases/4.1.4)       |             ✅              |
