...
|-----------------------------------------------------------------------------------|:-----------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:-----------------------------------------------------------------------------:|:--------------------------:|
| **[Gateway-Kong-Charts](https://github.com/telekom/gateway-kong-charts)**         |  **[latest](https://github.com/telekom/gateway-kong-charts/releases)**  |  **[9.4.1](https://github.com/telekom/gateway-kong-charts/releases/9.4.1)**   |  **[9.4.0](https://github.com/telekom/gateway-kong-charts/releases/9.4.0)**   |             ✅              |
| [Gateway-Kong-Image](https://github.com/telekom/gateway-kong-image)               |    [latest](https://github.com/telekom/gateway-kong-image/releases)     |     [1.5.0](https://github.com/telekom/gateway-kong-image/releases/1.5.0)     |     [1.4.1](https://github.com/telekom/gateway-kong-image/releases/1.4.1)     |             ✅              |
...
| [Gateway-Issuer-Service-Go](https://github.com/telekom/gateway-issuer-service-go) | [latest](https://github.com/telekom/gateway-issuer-service-go/releases) | [2.2.1](https://github.com/telekom/gateway-issuer-service-go/releases/v2.2.1) | [2.3.2](https://github.com/telekom/gateway-issuer-service-go/releases/v2.3.2) | for chart versions > 7.0.0 |
| [Gateway-Jumper](https://github.com/telekom/gateway-jumper)                       |      [latest](https://github.com/telekom/gateway-jumper/releases)       |       [4.3.1](https://github.com/telekom/gateway-jumper/releases/4.3.1)       |       [4.6.1](https://github.com/telekom/gateway-jumper/releases/4.6.1)       |             ✅              |
...
| Name                                                                                          |                                     Latest                                      |                                       Staging                                        |                                   Production Ready                                   | Mandatory |
|-----------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------:|:---------:|
| **[Identity-Iris-Keycloak-Charts](https://github.com/telekom/identity-iris-keycloak-charts)** | **[latest](https://github.com/telekom/identity-iris-keycloak-charts/releases)** | **[2.0.1](https://github.com/telekom/identity-iris-keycloak-charts/releases/2.0.1)** | **[2.0.1](https://github.com/telekom/identity-iris-keycloak-charts/releases/2.0.1)** |     ✅     |
| [Identity-Iris-Keycloak-Image](https://github.com/telekom/identity-iris-keycloak-image)       |   [latest](https://github.com/telekom/identity-iris-keycloak-image/releases)    |   [1.4.1](https://github.com/telekom/identity-iris-keycloak-image/releases/1.4.1)    |   [1.4.1](https://github.com/telekom/identity-iris-keycloak-image/releases/1.4.1)    |     ✅     |
